              ...
              <ul className="grid gap-3 p-6 w-[400px]">
                  ...
                  <NavigationMenuLink asChild>
                    ...
                    >
                      ...
                      <p className="text-sm leading-tight text-muted-foreground">
                        Discover our most powerful features and how they can help your business.
                      </p>
                    </a>
                  </NavigationMenuLink>
                </li>
                ...
                <li>
                  <Link href="/features/automation" legacyBehavior passHref>
                    <NavigationMenuLink className={navigationMenuTriggerStyle()}>Automation</NavigationMenuLink>
                  </Link>
                </li>
                <li>
                  <Link href="/features/reporting" legacyBehavior passHref>
                    <NavigationMenuLink className={navigationMenuTriggerStyle()}>Reporting</NavigationMenuLink>
                  </Link>
                </li>
              </ul>
            </NavigationMenuContent>
