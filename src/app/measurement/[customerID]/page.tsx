...
const getMeasurementById = (id: string) => {
  const mockMeasurements = [
    { id: '1', customerName: 'John Smith', customerId: '101', type: 'Chest', value: 40.5, notes: '', createdAt: '2023-10-02' },
    { id: '2', customerName: 'Jane Smith', customerId: '102', type: 'Waist', value: 32.0, notes: '', createdAt: '2023-10-02' },
    { id: '3', customerName: 'James Johnson', customerId: '103', type: 'Inseam', value: 34.0, notes: 'Slightly longer than previous measurement', createdAt: '2023-10-05' },
  ]
  return mockMeasurements.find(m => m.id === id)
}

export default function MeasurementDetailsPage({ params }: { params: { id: string } }) {
  const [measurement] = useState(getMeasurementById(params.id))
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-col items-center justify-center space-y-2 py-12 text-center">
              ...
              <p className="text-muted-foreground">The measurement you are looking for does not exist or has been removed.</p>
          ...
          <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-1">
              ...
              <dd className="text-base">
                <Link href={`/customers/${measurement.customerId}`} className="font-medium hover:underline">
                  {measurement.customerName}
                </Link>
              </dd>
            </div>
            <div className="space-y-1">
              <dt className="text-sm font-medium text-muted-foreground">Measurement Type</dt>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Are you sure you want to delete this {measurement.type} measurement for {measurement.customerName}? This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
