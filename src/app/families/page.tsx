        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage all your families here. Add new families, view their details, and organize customers into families.
              </CardDescription>
            </div>
            ...
            {filteredFamilies.length > 0 ? (
              <>
                      ...
                      {filteredFamilies.map((family) => (
                        <TableRow key={family.id}>
                          <TableCell className="font-medium">
                            <Link href={`/families/${family.id}`} className="hover:underline">
                              {family.name}
                            </Link>
                          </TableCell>
                ...
                <div className="text-sm text-muted-foreground">
                  Showing {filteredFamilies.length} of {mockFamilies.length} families
                </div>
              </>
            ) : (
